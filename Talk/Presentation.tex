...
\begin{frame}
  ...
  \begin{itemize}
  	\item 
	\item have story here,
	\item also explain root somewhere
	\item 
	\item 
  \end{itemize}
  \end{column}
...
that are already known to the IDS against captured events in order to identify a possible attack.
	\begin{itemize}
		\item It is a simple and effective way to detect known attacks, but is ineffective against new kinds of unknown attacks.
	\end{itemize}
  	\item Anomaly-based detection: looks for patterns of activity that are rare and uncommon.
	\begin{itemize}
		\item It is harder to do than signature-based detection, but it can be an effective way to detect new, unknown attacks.
	\end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{RLD09}
	\begin{itemize}
		\item RLD09 was created because KDD99 is 14 years old, and newer attack types are not included in it because of its age.
...
\linespace
\linespace
		\item .............maybe have something like "the authors of [6] used only the numerical features of KDD99 (34 out of 41)." if I decide to explain that paper.
	\end{itemize}
\end{frame}
...
\linespace
	\begin{itemize}
		...
		\linespace
		\linespace
		\item .........maybe talk about the other paper's DR?
	\end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Genetic Algorithms}
	\begin{itemize}
		\item GAs are a search technique used to find solutions to problems. Operations analogous to biological mutation, selection, and crossover are used to evolve and improve solutions.
...
\begin{frame}
	...
	\begin{itemize}
		\item The algorithm generates rules and improves rules.
...
\begin{frame}
	...
	Experiment 1
	\begin{itemize}
		\item Fuzzy GA was used to create DoS and probe detection rules. Both of the DoS and probe rules were then used together in the testing process to identify attacks from the testing data set.
