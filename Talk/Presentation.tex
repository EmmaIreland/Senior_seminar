...
\begin{frame}
  ...
  \begin{itemize}
  	...
  	\item Crossover takes 2 rules and creates new rules by swapping bits of old rules.
  \end{itemize}
\end{frame}
...
\frametitle{Conclusions}
	\begin{itemize}
		...
		\item The use of fuzzy genetic algorithms in intrusion detection is an effective way of detecting attacks - DR in experiments was in the high 90s.
	\end{itemize}
\end{frame}
